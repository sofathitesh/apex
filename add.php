...
function checkStateChange(){$("#sub_section select").on("focus",function(){$(this).change(function(){chkSubject($(this).data("i"),$("#"+$(this).attr("id")).val())})})}function getPackSection(e){$.ajax({type:"POST",url:'<?=base_url("index.php/student/getPackSection")?>',data:"id="+e,dataType:"html",success:function(e){sectionID=e,$("#section_ID").html('<input type="hidden" name="sectionID" id="sectionID" value="'+e+'">'),$(".sel_sub").each(function(){$(this).val(e).trigger("change")})},async:!1})}function chkSubject(e,a){var t=$("#classesID1").val();0!==a&&0!==t&&$.ajax({type:"POST",url:'<?=base_url("index.php/student/checkSubjectAvailable")?>',data:"subID="+e+"&classesID="+t+"&secID="+a,dataType:"html",success:function(a){"err"===a?($("#section"+e).parent().parent().addClass("has-error"),$("#error"+e).html("Subject full")):($("#section"+e).parent().parent().removeClass("has-error"),$("#error"+e).html(""))},async:!1})}$("#dob").datepicker({startView:2,dateFormat:"dd-mm-yy"});var sections="",sectionID;$("#classesID1").change(function(e){var a=$(this).val();"0"===a?$("#classesID").val(0):($.ajax({type:"POST",url:'<?=base_url("index.php/student/sectioncall")?>',data:"id="+a,dataType:"html",success:function(e){sections=e}}),$.ajax({type:"POST",url:'<?=base_url("index.php/student/callPackage")?>',data:"id="+a,dataType:"html",success:function(e){$("#packages").html(e),$("#sub_section").html("")}}),$("#add_p").html(""),$.ajax({type:"POST",url:'<?=base_url("student/callAdditionalPackage")?>',data:"id="+a,dataType:"html",success:function(e){var a='<select id="additional_pack" class="form-control" name="additional_pack[]" multiple="multiple">'+e+"</select>";$("#add_p").html(a),setTimeout(function(){$("#additional_pack").multiselect({includeSelectAllOption:!0})},300)}}))}),$("#packages").change(function(){var e=$(this).val();"0"===e?$("#sub_section").html(""):$.ajax({type:"POST",url:'<?=base_url("index.php/student/packagesubjectcall")?>',data:"packageID="+e,dataType:"html",success:function(a){$("#sub_section").html("");var t=JSON.parse(a),s=t.subs,c=t.overs;for(var l in s)c.includes(l)?$("#sub_section").append('<div class="form-group has-error"> <label for="sub'+l+'" class="col-sm-4 control-label"> '+s[l]+' </label> <input type="hidden" name="subject[]" value="'+l+'"> <div class="col-sm-6"> <select name="section[]" id="section'+l+'" class="form-control sel_sub" data-i="'+l+'">'+sections+'</select> </div><span class="control-label" id="error'+l+'"> Subject full</span> </div>'):$("#sub_section").append('<div class="form-group"> <label for="sub'+l+'" class="col-sm-4 control-label"> '+s[l]+' </label> <input type="hidden" name="subject[]" value="'+l+'"> <div class="col-sm-6"> <select name="section[]" id="section'+l+'" class="form-control sel_sub" data-i="'+l+'">'+sections+'</select> </div><span class="control-label" id="error'+l+'"> </span> </div>');checkStateChange(),getPackSection(e)}})});
</script>
<!--
